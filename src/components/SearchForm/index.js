...
function SearchForm() {
  ...
  return (
    <>
      <h1 className="layout-default__main__titleSearch">1000+ IT Jobs For Developers</h1>
      {city && (
        <Form onFinish={handleFinish}>
          <Row gutter={[12, 12]}>
            ...
            <Col xxl={3} xl={3} lg={3}>
              <Form.Item>
                <Button className="layout-default__main__btnSearch" type="primary" htmlType="submit" block>
                  Tìm kiếm
                </Button>
              </Form.Item>
            </Col>
